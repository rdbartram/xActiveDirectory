New-xDscResource -Name MSFT_xADDelegatePermission -FriendlyName xADDelegatePermission -ModuleName xActiveDirectory -Path . -Force -Property @(
    ...
    New-xDscResourceProperty -Name AccessType -Type string -Attribute Write -ValidateSet @("Allow", "Deny")
